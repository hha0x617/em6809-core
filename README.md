...
**canonical** reference.  For a GitHub-readable mirror that walks
through every module's public API surface and shows a runnable usage
snippet for each, see
[`docs/en/module_overview.md`](docs/en/module_overview.md)
([日本語版](docs/ja/module_overview.md)).

The very short version of "what's in here" is the `## Crate layout`
table above.
